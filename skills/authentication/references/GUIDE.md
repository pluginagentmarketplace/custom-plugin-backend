...
This guide provides comprehensive documentation for the **authentication** skill in the custom-plugin-backend plugin.
...
```bash
# Invoke the skill
claude "authentication - [your task description]"

# Example
claude "authentication - analyze the current implementation"
```
...
def implement_authentication(input_data):
    """
