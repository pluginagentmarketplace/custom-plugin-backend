...
This guide provides comprehensive documentation for the **microservices** skill in the custom-plugin-backend plugin.
...
```bash
# Invoke the skill
claude "microservices - [your task description]"

# Example
claude "microservices - analyze the current implementation"
```
...
def implement_microservices(input_data):
    """
    Implement microservices functionality.
