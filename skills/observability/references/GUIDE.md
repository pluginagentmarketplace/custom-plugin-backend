...
This guide provides comprehensive documentation for the **observability** skill in the custom-plugin-backend plugin.
...
```bash
# Invoke the skill
claude "observability - [your task description]"

# Example
claude "observability - analyze the current implementation"
```
...
def implement_observability(input_data):
    """
    Implement observability functionality.
