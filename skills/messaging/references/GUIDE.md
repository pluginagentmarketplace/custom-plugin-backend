...
This guide provides comprehensive documentation for the **messaging** skill in the custom-plugin-backend plugin.
...
```bash
# Invoke the skill
claude "messaging - [your task description]"

# Example
claude "messaging - analyze the current implementation"
```
...
def implement_messaging(input_data):
    """
