...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&duration=3000&pause=1000&color=2E9EF7&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=100&lines=Backend+Assistant;7+Agents+%7C+7+Skills;Claude+Code+Plugin" alt="Backend Assistant" />
...
> **Backend Assistant** is a Claude Code plugin with **7 agents** and **7 skills** for backend development.
...
| Feature | Description |
|---------|-------------|
| 🤖 **7 Agents** | Specialized AI agents for backend tasks |
